...
const INITIAL_CAMERA_POSITION = [1.5, 1, 2] as const;
...
function Scene({
  ...
  // TODO check how nested groups work on the skateboard
  // TODO       <group ref={containerRef} position={[-0.25, 0, -0.635]}>
  // TODO        <group position={[0, -0.086, 0.635]}>
