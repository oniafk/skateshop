...
export default function Controls({ wheels, decks, metals, className }: Props) {
  ...
  //TODO how <Option> imgixParams works why can I moddify the image with it with the rect and width and height
  return (
...
// TODO check how options change the url getting the UID from the elements
...
// TODO check why is good isea to omit props and how does it works here
