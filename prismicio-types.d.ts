...
export interface ProductGridSliceDefaultPrimaryProductItem {
   ...
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  skateboards: prismic.ContentRelationshipField<"skateboard">;
}
...
export interface VideoBlockSliceDefaultPrimary {
  /**
   * YouTubeVideo ID field in *VideoBlock → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: video_block.default.primary.youtubevideo_id
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  youtubevideo_id: prismic.KeyTextField;
}
